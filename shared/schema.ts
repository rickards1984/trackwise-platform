...
export type TwelveWeeklyReview = typeof twelveWeeklyReviews.$inferSelect;
export type InsertTwelveWeeklyReview = z.infer<typeof insertTwelveWeeklyReviewSchema>;
...
export type UpdateEmailVerification = z.infer<typeof updateEmailVerificationSchema>;
export type EmailVerification = typeof emailVerifications.$inferSelect;

export type InsertKsbElement = z.infer<typeof insertKsbElementSchema>;
export type KsbElement = typeof ksbElements.$inferSelect;

export type InsertApprenticeshipStandard = z.infer<typeof insertApprenticeshipStandardSchema>;
export type ApprenticeshipStandard = typeof apprenticeshipStandards.$inferSelect;
...
export type InsertEvidenceKsbMapping = z.infer<typeof insertEvidenceKsbMappingSchema>;
export type EvidenceKsbMapping = typeof evidenceKsbMapping.$inferSelect;

export type InsertOtjLogEntry = z.infer<typeof insertOtjLogEntrySchema>;
export type OtjLogEntry = typeof otjLogEntries.$inferSelect;
...
export type InsertCourseBuilderTemplate = z.infer<typeof insertCourseBuilderTemplateSchema>;
export type CourseBuilderTemplate = typeof courseBuilderTemplates.$inferSelect;

export type InsertWeeklyOtjTracking = z.infer<typeof insertWeeklyOtjTrackingSchema>;
export type WeeklyOtjTracking = typeof weeklyOtjTracking.$inferSelect;

export type InsertIlrFileUpload = z.infer<typeof insertIlrFileUploadSchema>;
export type IlrFileUpload = typeof ilrFileUploads.$inferSelect;

export type InsertIlrLearnerRecord = z.infer<typeof insertIlrLearnerRecordSchema>;
export type IlrLearnerRecord = typeof ilrLearnerRecords.$inferSelect;

export type InsertIlrValidationRule = z.infer<typeof insertIlrValidationRuleSchema>;
export type IlrValidationRule = typeof ilrValidationRules.$inferSelect;

export type InsertIlrValidationResult = z.infer<typeof insertIlrValidationResultSchema>;
export type IlrValidationResult = typeof ilrValidationResults.$inferSelect;
